...
public class MapElementXlsHandler implements GenericElementXlsHandler
{
		...
		)
	{
		try
		{
			...
			exporter.exportImage(MapElementImageProvider.getImage(exporterContext.getExporter().getJasperReportsContext(), element), gridCell, colIndex, rowIndex, emptyCols, yCutsRow, layout);
		}
		catch (Exception e)
		{
