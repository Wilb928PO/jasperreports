...
public class MapElementOdsHandler implements GenericElementOdsHandler
{
		...
		)
	{
		try
		{
			...
			exporter.exportImage(exporterContext.getTableBuilder(), MapElementImageProvider.getImage(exporterContext.getExporter().getJasperReportsContext(), element), gridCell);
		}
		catch (Exception e)
		{
