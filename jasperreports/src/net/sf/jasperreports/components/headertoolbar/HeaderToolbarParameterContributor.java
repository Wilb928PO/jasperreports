...
//			reportContext.setParameterValue(currentTableSortFieldsParam, sortFields); 
			...
			String paramFieldValueEnd = (String)reportContext.getParameterValue(HeaderToolbarElement.REQUEST_PARAMETER_FILTER_VALUE_END);
			
			String paramFilterType = (String)reportContext.getParameterValue(HeaderToolbarElement.REQUEST_PARAMETER_FILTER_TYPE);
			String paramFilterTypeOperator = (String)reportContext.getParameterValue(HeaderToolbarElement.REQUEST_PARAMETER_FILTER_TYPE_OPERATOR);
			String paramFilterPattern = (String)reportContext.getParameterValue(HeaderToolbarElement.REQUEST_PARAMETER_FILTER_PATTERN);
			...
			// remove filters
			String filterForFieldToRemove = (String) reportContext.getParameterValue(HeaderToolbarElement.REQUEST_PARAMETER_REMOVE_FILTER);
...
//			boolean mustRemove = (sortFields.get(indexOfExistingSortField)).getOrderValue().equals(SortOrderEnum.DESCENDING);
			boolean mustRemove = newSortField.getOrderValue() == null;
			if (mustRemove) {
