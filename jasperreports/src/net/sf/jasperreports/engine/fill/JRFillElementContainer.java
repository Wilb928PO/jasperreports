...
public abstract class JRFillElementContainer extends JRFillElementGroup
{
			...
			for(int i = 0; i < allElements.length; i++)
			{
				...
				if (element.isToPrint())
				{
					...
					if (printElement != null)
					{
						...
						addPrintElement(element, printElement, printContainer);
					}
				}
			}
		}
	...
	protected abstract void addPrintElement(JRFillElement element, JRPrintElement printElement, JRPrintElementContainer printContainer);
