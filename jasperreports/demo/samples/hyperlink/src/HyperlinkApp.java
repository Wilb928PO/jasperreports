...
public class HyperlinkApp extends AbstractSampleApp
{
	...
	public void fill() throws JRException
	{
		...
		JasperFillManager.getInstance(getJasperReportsContext()).fillToFile("build/reports/HyperlinkReport.jasper", null, new JREmptyDataSource());
	...
	{
		long start = System.currentTimeMillis();
		JasperPrintManager.getInstance(getJasperReportsContext()).print("build/reports/HyperlinkReport.jrprint", true);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToPdfFile("build/reports/HyperlinkReport.jrprint");
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToXmlFile("build/reports/HyperlinkReport.jrprint", false);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToXmlFile("build/reports/HyperlinkReport.jrprint", true);
		System.err.println("XML creation time : " + (System.currentTimeMillis() - start));
	}
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToHtmlFile("build/reports/HyperlinkReport.jrprint");
	...
	{
		long start = System.currentTimeMillis();
		JasperCompileManager.getInstance(getJasperReportsContext()).writeReportToXmlFile("build/reports/HyperlinkReport.jasper");
