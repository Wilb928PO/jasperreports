...
//					parameters.put("array", aw);
			...
			JasperFillManager.getInstance(getJasperReportsContext()).fillToFile("build/reports/I18nReport.jasper", parameters, new JREmptyDataSource());
	...
	public void view() throws JRException
	{
		...
		if (locale != null)
		{
			JasperViewer.viewReport(getJasperReportsContext(), "build/reports/I18nReport.jrprint", false, true, locale, null);
		}
	}
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToPdfFile("build/reports/I18nReport.jrprint");
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToXmlFile("build/reports/I18nReport.jrprint", false);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToXmlFile("build/reports/I18nReport.jrprint", true);
		System.err.println("XML creation time : " + (System.currentTimeMillis() - start));
	}
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToHtmlFile("build/reports/I18nReport.jrprint");
