...
public class JsonDataSourceApp extends AbstractSampleApp
{
	...
	public void fill() throws JRException
	{
		...
		JasperFillManager.getInstance(getJasperReportsContext()).fillToFile("build/reports/JsonCustomersReport.jasper", params);
	...
	{
		long start = System.currentTimeMillis();
		JasperPrintManager.getInstance(getJasperReportsContext()).print("build/reports/JsonCustomersReport.jrprint", true);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToPdfFile("build/reports/JsonCustomersReport.jrprint");
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToXmlFile("build/reports/JsonCustomersReport.jrprint", false);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToXmlFile("build/reports/JsonCustomersReport.jrprint", true);
		System.err.println("XML creation time : " + (System.currentTimeMillis() - start));
	}
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToHtmlFile("build/reports/JsonCustomersReport.jrprint");
