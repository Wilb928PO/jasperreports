...
public class SubreportApp extends AbstractSampleApp
{
	...
	public void fill() throws JRException
	{
		...
		JasperFillManager.getInstance(getJasperReportsContext()).fillToFile("build/reports/MasterReport.jasper", parameters, getDemoHsqldbConnection());
	...
	{
		long start = System.currentTimeMillis();
		JasperPrintManager.getInstance(getJasperReportsContext()).print("build/reports/MasterReport.jrprint", true);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToPdfFile("build/reports/MasterReport.jrprint");
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToXmlFile("build/reports/MasterReport.jrprint", false);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToXmlFile("build/reports/MasterReport.jrprint", true);
		System.err.println("XML creation time : " + (System.currentTimeMillis() - start));
	}
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.getInstance(getJasperReportsContext()).exportToHtmlFile("build/reports/MasterReport.jrprint");
